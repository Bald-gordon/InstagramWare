extends Node2D
@onready var garlic_container: HBoxContainer = $LifesContainer
@onready var garlic: TextureRect = $LifesContainer/Life1
@onready var garlic_2: TextureRect = $LifesContainer/Life2
@onready var garlic_3: TextureRect = $LifesContainer/Life3
@onready var garlic_4: TextureRect = $LifesContainer/Life4
@onready var garlic_5: TextureRect = $LifesContainer/Life5
